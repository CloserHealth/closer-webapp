                    ...
                    <div className="period-date-marker">
                        <span className="period-date-text absolute">
                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="15" viewBox="0 0 8 12" fill="none">
                                <path style={{ filter: 'contrast(60%)' }} d="M6.9261 6.34468L3.61807 0.933594L0.552715 6.30769C-0.161063 7.44649 -0.223356 8.92726 0.526435 10.1537C1.59223 11.8969 3.88865 12.4566 5.65623 11.405C7.42315 10.3538 7.9919 8.08922 6.9261 6.34468Z" fill="#F3282B" />
                            </svg>
                        </span>
                    </div>
                );
                    ...
                    {phases.map((item, i) => (
                        <div key={i} className="w-full">
                            <div className="flex space-x-2 items-center w-full">
                                <Image src={item.icon} alt='' width={18} height={18} style={{ filter: 'contrast(60%)' }} />
