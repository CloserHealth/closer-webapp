          ...
          <div className='mt-28'>
            ...
            <div className="grid grid-cols-2 gap-5 items-center mt-10">
              ...
              <div className="w-full h-auto px-[19px] py-[27px] bg-violet-100 rounded-2xl shadow border-t border-neutral-200 justify-center items-center inline-flex">
                <div className="self-stretch flex-col justify-start items-center gap-[3px] inline-flex">
                  <div className="justify-start items-center inline-flex">
                    <div className="text-stone-900 text-[3.5vw] font-semibold font-['Manrope'] leading-normal flex items-center space-x-1.5 justify-center -mr-4"><span>Follicular</span> <Image src={Assets.follicularPhase} alt="" width={17} height={17} /></div>
                    <div className="w-4 h-4 relative" />
                  </div>
              ...
              <div className="w-full h-auto px-[19px] py-[27px] bg-violet-100 rounded-2xl shadow border-t border-neutral-200 justify-center items-center inline-flex">
                <div className="self-stretch flex-col justify-start items-center gap-[3px] inline-flex">
                  <div className="justify-start items-center inline-flex">
                    <div className="text-stone-900 text-[3.5vw] font-semibold font-['Manrope'] leading-normal flex items-center space-x-1.5 justify-center -mr-4"><span>Luteal</span> <Image src={Assets.lutealPhase} alt="" width={17} height={17} /></div>
                    <div className="w-4 h-4 relative" />
                  </div>
