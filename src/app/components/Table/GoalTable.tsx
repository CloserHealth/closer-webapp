...
import { CreateNewGoalModal, QuestionBaseModal, StatusModal } from '../Modals/Modals';
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div className="flex justify-between items-center px-5 bg-[#F9FAFB] w-full h-auto py-3 border rounded-t-lg">
                    ...
                    <div className="flex space-x-7 items-center">
                        ...
                        <div>
                            <AppButton content="Create New Goal" isRounded={false} onClickButton={handleOpenCreateGoalModal} isLoading={undefined} />
                        </div>
                    </div>
                </div>
